...
\paragraph{Known issues:} the way to display icons on the cover page is not optimal, the user will probably have to manually tune the \inlinecode{latex}{\includegraphics} settings.
